...
export const mapLocations = [
  ...
  },
  {
    ...
    size: "lg",
    color: "blue",
    description: "The breathtaking and magnificent island kingdom engineered and built by Lord Krishna. Widely celebrated as a divine haven and the glorious gateway to spiritual liberation, it functioned as the virtually impenetrable coastal stronghold of the Yadava clan, safeguarding its citizens and treasures through times of immense political turbulence."
  },
  {
    id: "mathura",
    name: "Mathura",
  ...
  },
  {
    ...
    size: "lg",
    color: "red",
    description: "A formidable, highly prosperous, and dominant empire that exerted immense political influence across ancient India. Once ruled by the fiercely powerful and seemingly invincible King Jarasandha, Magadha became the stage for a legendary historical clash before Jarasandha met his end during a grueling wrestling duel against Bhima."
  },
  {
    id: "kasi",
    name: "Kasi",
  ...
  },
  {
    ...
    size: "lg",
    color: "amber",
    description: "A rich and culturally prosperous kingdom governed by the proud King Drupada. Panchala achieved immense historical importance when it forged a vital, game-changing political and familial alliance with the Pandavas following the dramatic and highly contested Swayamvar of Princess Draupadi."
  },
  {
    id: "gandhara",
